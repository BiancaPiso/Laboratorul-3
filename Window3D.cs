...
namespace ConsoleApp4
{
    class Window3D : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            {
                Matrix4 lookat = Matrix4.LookAt(mouse.X, mouse.Y, mouse.WheelPrecise, 0, 0, 0, 0, 1, 0);
                GL.MatrixMode(MatrixMode.Modelview);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // RENDER CODE
            //firstTriangle.Draw();
            firstTriangle.DrawTriangle(); //Laborator03
        ...
        private void DisplayHelp()
        {
            ...
            Console.WriteLine(" V - afiseaza/ascunde triunghi");
            ...
            Console.WriteLine(" O - afiseaza/ascunde triunghi - Lab03");
            Console.WriteLine(" Hold Left Click + mouse wheel movement - schimba unghiul camerei - Lab03 ");
        }
    }
}
